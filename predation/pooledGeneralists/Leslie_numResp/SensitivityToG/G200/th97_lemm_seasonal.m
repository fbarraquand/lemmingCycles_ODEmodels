...
K = 500; % much more than at Traill island, negligible
G = 300; %80; % max value (30-40, low but plausible)
...
% Compute mortalities
MReg =  r_max*yout(:,1); %%% Perhaps that one was not computed well before
...
print(figure(3),'-dpdf','-r300','TimeSeriesLogScale_LemmingLikeTH97_SinusoidalSeasonality_G300')

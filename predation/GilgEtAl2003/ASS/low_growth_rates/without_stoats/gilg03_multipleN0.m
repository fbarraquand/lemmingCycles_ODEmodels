...
y0=[4 0 0];                            % initial values of state variables vector
...
y0=[0.01 0 0];                            % initial values of state variables vector
...
figure,
plot(log(y11(1:(end-1))),log(y11(2:end)))
hold on
plot(log(y12(1:(end-1))),log(y12(2:end)),'Color','k')
hold off
title('Phase-Space plot')
xlabel('log(Lemming density)_t')
ylabel('log(Lemming density)_{t+1}')

...
dydt(1) = r*y(1) - G*(1-Winter)*y(1)^4/(y(1)^4+H^4) - C*y(1)^2*y(2)/(y(1)^2+D^2);  % - r_max*y(1)^2/K  - C*y(1)*y(2)/(y(1)+D); % type II functional response instead / in the regulation term we could have r instead of r_max

...
function dydt = th97_seasonal_gen_func_IR(t,y)
...
M3 = a*y(2)/(y(1)+d);
dydt(1) = (r*(Winter) - M1 - M2 - M3)*y(1);  % Now 2-Winter as the max of this variable is 2 now (mean=1), so that 1-cos is in the parenthesis
